...
Repositorio de avances y herramientas, organizado por proyecto.
...
La copia local de este repositorio se llama `IA-ASF`. Cada proyecto vive en su propia carpeta:
...
Para agregar otro proyecto, cree una carpeta hermana de `ocr_masivo` y añada su descripción a la tabla. Mantenga sus instrucciones y dependencias dentro de esa carpeta.
